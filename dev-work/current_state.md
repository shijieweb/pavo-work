...
| 2026-08-13 | 主理人(合伙人) | T-20260813-04 取消鉴权+8787系统自启 | 进行中→完成 | 老板决策"仅本地单人·默认取消鉴权·3一样不做"；回退令牌闸(dec5ce9·34行纯删除·py_compile过·残留清空)；注册 schtasks AgnesPortal(onlogon) + start_portal.bat(托管python+崩溃重启)；杀旧PID6336→新PID26296接管8787；无token全通(200/200/400业务层/200)；8777自愈200；AC-1~5 全 PASS |
